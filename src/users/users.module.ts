...
// 이 모듈의 서비스 레이어에서 사용할 User 엔티티를 가져옵니다.
import { User } from './entities/user.entity';

/**
 * @class UsersModule
 * @description 사용자 관련 기능(Controller, Service)들을 하나로 묶어주는 모듈입니다.
 */
@Module({
  // imports: 이 모듈에서 사용할 다른 모듈들을 등록합니다.
  imports: [
    // TypeOrmModule.forFeature(): 이 모듈의 스코프 내에서 사용할 Repository를 등록합니다.
    // 여기에 등록된 User 엔티티는 UsersService에서 Repository를 통해 데이터베이스와 상호작용하는 데 사용됩니다.
